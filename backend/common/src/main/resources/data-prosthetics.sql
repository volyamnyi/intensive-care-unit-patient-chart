...
VALUES
    ...
    ('d0000003-0000-0000-0000-000000000003', 'c0000001-0000-0000-0000-000000000001', 4, 'Збірка протезу', 'TECHNICAL', false, false),
    ('d0000004-0000-0000-0000-000000000004', 'c0000001-0000-0000-0000-000000000001', 5, 'Контроль якості', 'ADMINISTRATIVE', false, true)
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ...
    ('f0000042-0000-0000-0000-000000000001', 'e0000041-0000-0000-0000-000000000001', 4, 'CHECKBOX', 'Тестову гільзу термоформовано', NULL, true, NULL, NULL, NULL, NULL, NULL),
    ('f0000043-0000-0000-0000-000000000001', 'e0000042-0000-0000-0000-000000000002', 1, 'CHECKBOX', 'Примірку проведено, тестова гільза відповідає параметрам кукси', NULL, true, NULL, NULL, NULL, NULL, NULL),
