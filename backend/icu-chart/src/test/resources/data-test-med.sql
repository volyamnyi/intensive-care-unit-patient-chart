...
TRUNCATE prescription_executions, prescription_day_parts, prescription_item_days, prescription_items, prescription_lists, prescription_signatures, vital_sign_entries, vital_sign_days, vital_sign_lists, drug_interaction_drugs, drug_interaction_pairs, telegram_subscriptions RESTART IDENTITY CASCADE;
