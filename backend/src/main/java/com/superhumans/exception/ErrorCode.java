...
public final class ErrorCode {
    ...
    public static final String EPISODE_ALREADY_ACTIVE = "EPISODE_ALREADY_ACTIVE";
    public static final String CLINICAL_DAY_ALREADY_OPEN = "CLINICAL_DAY_ALREADY_OPEN";
    public static final String INVALID_CLINICAL_VALUE = "INVALID_CLINICAL_VALUE";
