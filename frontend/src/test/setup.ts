...
vi.mock('react-i18next', () => {
  const uk: Record<string, unknown> = {
    ...
    labResults: { testLabel: 'Тест', allTestsEntered: 'Всі тести введено', resultLabel: 'Результат', refRange: 'Норма: {min}–{max} {unit}', addButton: 'Додати', noResults: 'Немає результатів лабораторії', testColumn: 'Тест', resultColumn: 'Результат', unitColumn: 'Од.', refRangeColumn: 'Референс', flagColumn: 'Позначка', abnormal: 'Відхилення' },
    ...
    auditLog: { title: 'Журнал аудиту', view: 'Переглянути журнал аудиту', hide: 'Сховати', loading: 'Завантаження...', empty: 'Немає записів аудиту', filterByEntity: 'Фільтр за сутністю', tableHeaders: { timestamp: 'Час', user: 'Користувач', entity: 'Сутність', action: 'Дія', changes: 'Зміни' } },
