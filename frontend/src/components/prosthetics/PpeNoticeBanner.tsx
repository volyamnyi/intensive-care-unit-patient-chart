 ...
 * у візарді «Виробництво протезів» (епік PPE, #294).
 *
 ...
 *
 * Гілки за `notice.kind` додаються поетапно (#294: `full-kit`, #295: `nitrile`);
 * невідомий kind рендериться в `null`, а не падає.
 */
